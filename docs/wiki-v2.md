...
| 部署 | GCS + gcsfuse 反代 | `gs://chris-pgp-host-asia/cc-pages/wiki-v2/` |
  ...
  "results": [
    {
      ...
      "url": "https://cc.higcp.com/wiki-v2/entities/tpu-v7"
    }
  ],
  "query_time_ms": 12.3
}
...
```bash
# 手动同步到 GCS
gsutil -m rsync -r -d ~/my-wiki-v2/public/ gs://chris-pgp-host-asia/cc-pages/wiki-v2/
```
