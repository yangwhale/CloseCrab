#!/bin/bash
# GB200 GKE 质检 Profile — tencent-gcp-taiji-poc
# source 后所有 QA_* 变量就位
...
export QA_RDMA_NICS=4               # GB200 A4X: 4× CX-7
...
export QA_KUBE_CONTEXT="gke_tencent-gcp-taiji-poc_us-east1_gb200-gke-test"

# === GCP ===
export QA_GCLOUD_CONFIG=taiji-poc
export QA_PROJECT=tencent-gcp-taiji-poc
export QA_ZONE=us-east1-d
export QA_RESERVATION_LABEL_KEY="cloud.google.com/reservation-subblocks"
export QA_RESERVATION_PREFIX="nvidia-gb200-xvb8jh1huhy5y-block-0001-subblock"
...
-x UCX_NET_DEVICES=gpu0rdma0,gpu1rdma0,gpu2rdma0,gpu3rdma0 \
-x NCCL_DEBUG=WARN"
...
export QA_GKE_CLUSTER=${QA_GKE_CLUSTER:-gb200-gke-test}
